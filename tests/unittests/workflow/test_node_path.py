...
def test_node_name_returns_full_segment_when_no_id_present():
  ...
  path = _NodePath.from_string('wf@1/node')
  assert path.node_name == 'node'
...
def test_is_descendant_of_returns_true_for_deep_child():
  ...
  ancestor = _NodePath.from_string('wf@1')
  descendant = _NodePath.from_string('wf@1/node@2')
...
def test_is_descendant_of_returns_false_for_unrelated_path():
  ...
  ancestor = _NodePath.from_string('wf@1')
  other = _NodePath.from_string('other@1/node@2')
...
def test_is_direct_child_of_returns_true_for_direct_child():
  ...
  parent = _NodePath.from_string('wf@1')
  child = _NodePath.from_string('wf@1/node@2')
...
def test_is_direct_child_of_returns_false_for_grandchild():
  ...
  parent = _NodePath.from_string('wf@1')
  descendant = _NodePath.from_string('wf@1/inner@1/node@2')
  assert not descendant.is_direct_child_of(parent)


def test_get_direct_child_name_returns_segment_after_prefix():
  """get_direct_child_name extracts the segment immediately following the prefix."""
  parent = _NodePath.from_string('wf@1')
  descendant = _NodePath.from_string('wf@1/inner@1/node@2')
  assert parent.get_direct_child_name(descendant) == 'inner@1'


def test_get_direct_child_name_raises_value_error_for_unrelated_path():
  """get_direct_child_name raises ValueError if descendant does not start with self."""
  parent = _NodePath.from_string('wf@1')
  other = _NodePath.from_string('other@1/node@2')
  with pytest.raises(ValueError):
    parent.get_direct_child_name(other)
